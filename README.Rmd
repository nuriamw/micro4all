...
The goal of micro4all is to wrapped all functions used in our laboratory to get a complete analysis of amplicon data for microbial community studies. It includes several useful tools, as an automatized detection of MOCK community and calculation of community cut-off as well as loops for statistical analysis.  
...
For a full and detailed workflow with micro4all functions, see [INTRODUCIR GITHUB]
